...
def summation_using_accumulate(n, term):
    ...
    """
    # "*** YOUR CODE HERE ***"
    return term(0) if n==0 else summation_using_accumulate(n-1, term)+term(n)
...
def product_using_accumulate(n, term):
    ...
    """
    # "*** YOUR CODE HERE ***"
    return term(n) if n==1 else product_using_accumulate(n-1, term)*term(n)
...
def funception(func_a, start):
    ...
    def func_b(stop):
        if start < 0:
            ...
            return func_a(start)
        elif start==stop and start==0:
            return func_a(start)#1
        elif start==stop and start>0:
            return 1
        else:
